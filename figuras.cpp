...
///////////prima propio ggggg//////////////
void CFiguras::prisma3(float altura, float largo, float profundidad, GLuint text, GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::prismam(float altura, float largo, float profundidad, GLuint text, GLuint text2)  //Funcion creacion prisma
{
	...
	glBegin(GL_POLYGON);  //Top
		//glColor3f(0.8,0.2,0.4);
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(avanza, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(avanza, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(1.0f, 1.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[7]);
	glEnd();
}
...
void CFiguras::prisma4(float altura, float largo, float profundidad, GLuint text, GLuint text2, GLuint text3, GLuint text4, GLuint text5, GLuint text6 )  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.5, 0.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.5, 1.8); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 1.8); glVertex3fv(vertice[7]);
	glEnd();
}
...
void CFiguras::toros(GLfloat radioM, GLfloat radiom, int meridianos, int paralelos,GLuint text)
{
	...
	float ctext_p = 1.0 / paralelos;
	float ctext_m = 1.0 / meridianos;

	GLdouble angulop = 2 * 3.1415 / paralelos;
	GLdouble angulom = 1 * 3.1415 / meridianos;
	...
	for (i = 0;i < meridianos;i++)
	{
		for (j = 0;j < paralelos;j++)
		{
			...
			glBegin(GL_POLYGON);
			glTexCoord2f(ctext_p*i, ctext_m*j); glVertex3fv(v1);
			glTexCoord2f(ctext_p*(i + 1), ctext_m*j);glVertex3fv(v2);
			glTexCoord2f(ctext_p*(i + 1), ctext_m*(j + 1));glVertex3fv(v3);
			glTexCoord2f(ctext_p*i, ctext_m*(j + 1));glVertex3fv(v4);
			glEnd();
		}
	}
}
