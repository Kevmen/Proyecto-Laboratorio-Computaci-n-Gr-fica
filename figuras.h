...
class CFiguras
{
	...
	void toros(GLfloat radioM, GLfloat radiom, int meridianos, int paralelos, GLuint text);
	...
	void prismam(float altura, float largo, float profundidad, GLuint text, GLuint text2);
	void prisma4(float altura, float largo, float profundidad, GLuint text, GLuint text2, GLuint text3, GLuint text4, GLuint text5, GLuint text6);
