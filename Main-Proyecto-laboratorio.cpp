...
{
	glPushMatrix();
		glBindTexture(GL_TEXTURE_2D, ParedSala.GLindex);
		glBegin(GL_QUADS);//muro largo
			glColor3f(1.0, 0.0, 1.0);
			glNormal3f(0.0f, 0.0f, 1.0f);
			glTexCoord2f(0.0f, 0.0f); glVertex3f(0.0, 0.0, 0.0);
			glTexCoord2f(1.0f, 0.0f); glVertex3f(5, 0, 0.0);
			glTexCoord2f(1.0f, 1.0f);glVertex3f(5, 3, 0.0);
			glTexCoord2f(0.0f, 1.0f);glVertex3f(0, 3, 0.0);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		...
		glBegin(GL_QUADS);//muro largo reverse
			...
			glTexCoord2f(1.0f, 0.0f); glVertex3f(5, 0, -0.001);
			glTexCoord2f(1.0f, 1.0f);glVertex3f(5, 3, -0.001);
			glTexCoord2f(0.0f, 1.0f);glVertex3f(0, 3, -0.001);
		glEnd();
	glPopMatrix();

	glPushMatrix();
		glBindTexture(GL_TEXTURE_2D, terxturapared1.GLindex);
		glBegin(GL_QUADS);//muro puerta cuarto
			glColor3f(1.0, 0.0, 1.0);
			glNormal3f(-1.0f, 0.0f, 0.0f);
			glTexCoord2f(0.0f, 0.0f); glVertex3f(5.0, 0.0, 0.0);
			glTexCoord2f(2.0, 0.0f); glVertex3f(5, 0, 1.8);
			glTexCoord2f(2.0, 2.0); glVertex3f(5, 3, 1.8);
			glTexCoord2f(0.0f, 2.0); glVertex3f(5.0, 3, 0.0);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//contra puerta entrada reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(0.0f, 0.0f, 1.0f);
			glVertex3f(5.0, 0.0, 1.799);
			glVertex3f(6.2, 0, 1.799);
			glVertex3f(6.2, 3, 1.799);
			glVertex3f(5.0, 3, 1.799);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//adyacente puerta entrada reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(-1.0f, 0.0f, 0.0f);
			glVertex3f(6.201, 0.0, 1.8);
			glVertex3f(6.201, 0, 3.0);
			glVertex3f(6.201, 3, 3.0);
			glVertex3f(6.201, 3, 1.8);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//puerta entrada reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(6.2, 0.0, 3.001);
			glVertex3f(5.4, 0, 3.001);
			glVertex3f(5.4, 3, 3.001);
			glVertex3f(6.2, 3, 3.001);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//entre puertas reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(5.4, 0.0, 3.001);
			glVertex3f(4.9, 0, 3.001);
			glVertex3f(4.9, 3, 3.001);
			glVertex3f(5.4, 3, 3.001);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//puerta b reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(4.9, 0.0, 3.001);
			glVertex3f(4.7, 0, 3.001);
			glVertex3f(4.7, 3, 3.001);
			glVertex3f(4.9, 3, 3.001);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//muro pequeño reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(4.7, 0.0, 3.001);
			glVertex3f(2.9, 0, 3.001);
			glVertex3f(2.9, 3, 3.001);
			glVertex3f(4.7, 3, 3.001);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//muro adyacente cocina
			...
			glVertex3f(2.9, 0.0, 4.4);
			glVertex3f(2.9, 3, 4.4);
			glVertex3f(2.9, 3, 3.0);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//muro adyacente cocina reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(-1.0, 0.0f, 0.0);
			glVertex3f(2.901, 0.0, 3.0);
			glVertex3f(2.901, 0.0, 4.4);
			glVertex3f(2.901, 3, 4.4);
			glVertex3f(2.901, 3, 3.0);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//contra muro cocina reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(0.0, 0.0f, -1.0);
			glVertex3f(2.9, 0.0, 4.401);
			glVertex3f(0.0, 0.0, 4.401);
			glVertex3f(0.0, 3, 4.401);
			glVertex3f(2.9, 3, 4.401);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//base ventana cocina reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(1.0, 0.0f, 0.0);
			glVertex3f(-0.001, 0.0, 4.4);
			glVertex3f(-0.001, 0.0, 3.0);
			glVertex3f(-0.001, 1.2, 3.0);
			glVertex3f(-0.001, 1.2, 4.4);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//ventana cocina izquierda
			...
			glNormal3f(1.0, 0.0f, 0.0);
			glVertex3f(0.0, 1.2, 4.4);
			glVertex3f(0.0, 1.2, 3.9);
			glVertex3f(0.0, 3.0, 3.9);
			glVertex3f(0.0, 3.0, 4.4);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//ventana cocina izquierda reverse
			...
			glNormal3f(1.0, 0.0f, 0.0);
			glVertex3f(-0.001, 1.2, 4.4);
			glVertex3f(-0.001, 1.2, 3.9);
			glVertex3f(-0.001, 3.0, 3.9);
			glVertex3f(-0.001, 3.0, 4.4);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//ventana cocina top
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(1.0, 0.0f, 0.0);
			glVertex3f(0.0, 2.7, 4.4);
			glVertex3f(0.0, 2.7, 3.0);
	...
	glPushMatrix();
		glBegin(GL_QUADS);//ventana cocina top reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(1.0, 0.0f, 0.0);
			glVertex3f(-0.001, 2.7, 4.4);
			glVertex3f(-0.001, 2.7, 3.0);
			glVertex3f(-0.001, 3.0, 3.0);
			glVertex3f(-0.001, 3.0, 4.4);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//cadena up reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(2.9, 2.75, 3.15);
			glVertex3f(2.1, 2.75, 3.15);
			glVertex3f(2.1, 3, 3.15);
			glVertex3f(2.9, 3, 3.15);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//muro1cocinabloque reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(2.1, 0.25, 3.15);
			glVertex3f(1.4, 0.25, 3.15);
			glVertex3f(1.4, 3.0, 3.15);
			glVertex3f(2.1, 3.0, 3.15);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//base barra
			...
			glVertex3f(0.7, 1.2, 3.0);
			glVertex3f(1.4, 1.2, 3.0);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//base barra reverse
			...
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(1.4, 0.25, 3.15);
			glVertex3f(0.7, 0.25, 3.15);
			glVertex3f(0.7, 1.2, 3.15);
			glVertex3f(1.4, 1.2, 3.15);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//top barra
			...
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(1.4, 3.0, 3.0);
			glVertex3f(1.4, 2.6, 3.0);
			glVertex3f(0.7, 2.6, 3.0);
	...
	glPushMatrix();
		glBegin(GL_QUADS);//top barra reverse
			...
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(1.4, 3.0, 3.15);
			glVertex3f(1.4, 2.6, 3.15);
			glVertex3f(0.7, 2.6, 3.15);
			glVertex3f(0.7, 3.0, 3.15);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_TRIANGLES);//barra triangulo izquierda
			...
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(1.4, 2.6, 3.0);
			glVertex3f(1.4, 2.2, 3.0);
			glVertex3f(1.15, 2.6, 3.0);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//barra triangulo izquierda lateral
			...
			glVertex3f(1.4, 2.2, 3.0);
			glVertex3f(1.4, 2.2, 3.15);
			glVertex3f(1.15, 2.6, 3.15);
			glVertex3f(1.15, 2.6, 3.0);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_TRIANGLES);//barra triangulo derecha
			...
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(0.7, 2.6, 3.0);
			glVertex3f(0.95, 2.6, 3.0);
			glVertex3f(0.7, 2.2, 3.0);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//barra triangulo derecha lateral
			...
			glNormal3f(0.4, 0.25, 0.0);
			glVertex3f(0.7, 2.2, 3.0);
			glVertex3f(0.7, 2.2, 3.15);
			glVertex3f(0.95, 2.6, 3.15);
			glVertex3f(0.95, 2.6, 3.0);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		...
		glColor3f(1.0, 0.0, 0.0);
		glNormal3f(0.0, 1.0f, 0.0);
		glVertex3f(0.7, 1.2, 2.75);
		glVertex3f(0.7, 1.2, 3.35);
		glVertex3f(1.4, 1.2, 3.35);
		glVertex3f(1.4, 1.2, 2.75);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);// barra up
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(0.0, 1.0f, 0.0);
			glVertex3f(0.7, 1.3, 2.75);
			glVertex3f(0.7, 1.3, 3.35);
			glVertex3f(1.4, 1.3, 3.35);
			glVertex3f(1.4, 1.3, 2.75);
		glEnd();
	glPopMatrix();
	...
	glPushMatrix();
		glBegin(GL_QUADS);//muro2cocinabloque reverse
			...
			glNormal3f(0.0f, 0.0f, -1.0f);
			glVertex3f(0.7, 0.25, 3.15);
			glVertex3f(0.0, 0.25, 3.15);
			glVertex3f(0.0, 3.0, 3.15);
			glVertex3f(0.7, 3.0, 3.15);
		glEnd();
	glPopMatrix();
	...
	glBindTexture(GL_TEXTURE_2D, paredexterior.GLindex);
		glBegin(GL_QUADS);// ventana principal derecha reverse
			glColor3f(1.0, 0.0, 0.0);
			glNormal3f(1.0f, 0.0f, 0.0f);
			glVertex3f(-0.001, 1.2, 0.6);
			glVertex3f(-0.001, 1.2, 0.0);
			glVertex3f(-0.001, 3.0, 0.0);
			glVertex3f(-0.001, 3.0, 0.6);
		glEnd();
	glPopMatrix();
	...
	glBindTexture(GL_TEXTURE_2D, paredexterior.GLindex);
		glBegin(GL_QUADS);// ventana principal top reverse
			...
			glTexCoord2f(2.0, 0.0); glVertex3f(-0.001, 2.7, 0.6);
			glTexCoord2f(2.0, 1.0); glVertex3f(-0.001, 3.0, 0.6);
			glTexCoord2f(0.0, 1.0); glVertex3f(-0.001, 3.0, 2.4);
		glEnd();
	glPopMatrix();
...
{
	glPushMatrix();
		Cajonera.prisma(0.1, 1.8, 0.6, Textura_Madera.GLindex);//cajonera base
		glPushMatrix();
			glTranslatef(-0.85, 0.55, 0.0);
			Cajonera.prisma(1.0, 0.1, 0.6, Textura_Madera.GLindex);//lado izquierdo
			glTranslatef(1.7, 0.0, 0.0);
			Cajonera.prisma(1.0, 0.1, 0.6, Textura_Madera.GLindex);//lado derecho
			glTranslatef(-0.85, 0.0, -0.25);
			Cajonera.prisma(1.0, 1.78, 0.1, Textura_Madera.GLindex);//lado trasero
			glTranslatef(0.0, 0.55, 0.25);
			Cajonera.prisma(0.1, 2.0, 0.8, Textura_Madera.GLindex);//tapa
		glPopMatrix();
		glPushMatrix();//cajon base izquierdo
			glTranslatef(-0.4, 0.1, 0.1);
			Cajonera.prisma(0.05, 0.8, 0.5, Textura_Madera.GLindex);//cAJON BASE
			glTranslatef(-0.4, 0.2, 0.0);
			Cajonera.prisma(0.45, 0.05, 0.5, Textura_Madera.GLindex);//cAJON lado izquierdo
			glTranslatef(0.8, 0.0, 0.0);
			Cajonera.prisma(0.45, 0.05, 0.5, Textura_Madera.GLindex);//cAJON lado derecho
			glTranslatef(-0.4, 0.0, -0.25);
			Cajonera.prisma(0.45, 0.8, 0.05, Textura_Madera.GLindex);//cAJON trasero
			glTranslatef(0.0, 0.0, 0.5);
			glRotatef(90, 1.0, 0.0, 0.0);
			Cajonera.prisma3(0.05, 0.8, 0.45, Textura_Madera.GLindex,texturapared4.GLindex);//cAJON frente			
		glPopMatrix();
